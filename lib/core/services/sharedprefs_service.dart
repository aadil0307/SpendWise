...
class SharedPrefrencesService {
  ...
  final String balanceThresholdKey = 'balanceThreshold';

  Future<int> getBalanceThreshold() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getInt(balanceThresholdKey);
  }

  Future<void> setBalanceThreshold(int threshold) async {
    final prefs = await SharedPreferences.getInstance();
    prefs.setInt(balanceThresholdKey, threshold);
  }
